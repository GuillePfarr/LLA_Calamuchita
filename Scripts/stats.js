...
fetch("https://mindhub-xj03.onrender.com/api/amazing")
  ...
  .then(data => {
    ...
    arrayFutures = futures(data.events, data.currentDate)
    console.log(arrayPast)
    console.log(arrayFutures)
    imprimeTabla(results(assistance(arrayPast), assistance(arrayPast).reverse(), capacity(arrayPast)), "datosSuperior")
    printTable(dataTable(arrayFutures), "upcoming")
...
function imprimeTabla(results, container) {
